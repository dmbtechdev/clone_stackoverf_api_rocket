...
// ---- CRUD for Questions ----
#[get("/")]
pub async fn root() -> Result<String, APIError> {
    Ok(format!("Welcome to Api via Rocket"))
}

#[get("/test")]
pub async fn test() -> Result<String, APIError> {
    Ok(format!("Welcome to Test"))
}


#[post("/question/create", data = "<question>")]
...
#[delete("/question/delete", data = "<question_uuid>")]
